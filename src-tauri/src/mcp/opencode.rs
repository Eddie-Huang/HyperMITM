...
//!
//! 本模块处理 Hyper MITM 统一 MCP 格式与 OpenCode 格式之间的转换。
//!
//! ## 格式差异
//!
//! | Hyper MITM 统一格式    | OpenCode 格式       |
//! |----------------------|---------------------|
...
// ============================================================================
// Format Conversion: Hyper MITM → OpenCode
// ============================================================================

/// Convert Hyper MITM unified format to OpenCode format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: OpenCode → Hyper MITM
// ============================================================================

/// Convert OpenCode format to Hyper MITM unified format
///
/// Conversion rules:
